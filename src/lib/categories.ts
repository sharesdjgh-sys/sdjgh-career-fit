...
export const CATEGORY_COLORS: Record<string, { accent: string; tint: string }> = {
  "IT·디지털기술": { accent: "#3B6EA5", tint: "#EAF1F8" },
  "예술·문화·미디어": { accent: "#8B5C9E", tint: "#F2ECF8" },
  "공학·제조·건설": { accent: "#5B6B82", tint: "#EDEFF3" },
  "서비스·유통·음식": { accent: "#CE6A3D", tint: "#FAEEE6" },
  "공공·사회·복지": { accent: "#3E8E7E", tint: "#E6F2EF" },
  "경제·금융·법률": { accent: "#B5882F", tint: "#F7F0E0" },
  "환경·에너지·농업": { accent: "#5A934A", tint: "#ECF3E8" },
  "의료·보건": { accent: "#C2506A", tint: "#FAE8EC" },
  "연구·과학": { accent: "#2F8FA6", tint: "#E4F1F4" },
  "스포츠·레저": { accent: "#D15B57", tint: "#FBEAE9" },
  "교육": { accent: "#6A5BB0", tint: "#EFECF9" },
};
